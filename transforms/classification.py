...
def add_argparser_cls_transform(parent_parser: ArgumentParser, is_train: bool) -> ArgumentParser:
    if is_train:
...
def create_cls_transform(is_train: bool, max_pixel_value: float, **kwargs):
    if is_train:

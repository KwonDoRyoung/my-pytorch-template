...
class NestedUNet(SegmentationModelTemplate):
    def __init__(self, num_classes: int, deep_supervision:bool, is_inference: bool, criterion_name: str = "", **kwargs) -> None:
    ...
    @staticmethod
    def add_argparser(parent_parser: ArgumentParser, is_inference: bool=True) -> ArgumentParser:
    ...
    def forward(self, inputs):
        ...
        if self.deep_supervision:
            outputs1 = self.final1(x0_1)
            outputs2 = self.final2(x0_2)
            outputs3 = self.final3(x0_3)
            outputs4 = self.final4(x0_4)
